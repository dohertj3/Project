...
// Function used to find which processes talk to one another and which points are sent;
void SFC_Neighbours(SFC* test, int rank, int nproc, int a, int b, std::vector< std::list<int> > &comms, std::vector< std::list<int> > &send_com);
